...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,reactnative,tailwind,sass,redux,nodejs,npm,git,github,mongodb,mysql,postgresql,supabase,vercel,netlify,figma,ps,ai,pr,ae&theme=dark)](https://skillicons.dev)
